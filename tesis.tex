...
\title{Implementación de un transmisor ISDB-T abierto bajo el paradigma de Radio Definida por Software}
\author{Santiago Castro, Javier Hernández} % Nombre del autor o los autores
\date{\today} % Fecha de la defensa
\email{mail@fing.edu.uy} % email de contacto
\location{Montevideo} %
\documenturl{http://iie.fing.edu.uy/} 

\TutorNombreA{Federico Larroca}
\TutorAfiliacionA{Universidad de la Rep\'ublica}
\TutorNombreB{Pablo Flores}
